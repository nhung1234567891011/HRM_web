...
@Component({
  selector: 'app-update-common-container',
  templateUrl: './update-common-container.component.html',
  styleUrl: './update-common-container.component.scss'
})
export class UpdateCommonContainerComponent implements OnInit {
  	items: any;
	...
	handleChangePage(page) {
		this.pageFlag = page;
		console.log(this.pageFlag); // Kiểm tra giá trị pageFlag
